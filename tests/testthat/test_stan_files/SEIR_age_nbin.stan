// Code generated by the R package readsdr v0.2.0.9016
...
model {
  ...
  y_A ~ neg_binomial_2(delta_x_1, phi);
  y_B ~ neg_binomial_2(delta_x_2, phi);
  y_C ~ neg_binomial_2(delta_x_3, phi);
  y_D ~ neg_binomial_2(delta_x_4, phi);
}
generated quantities {
  ...
  log_lik = neg_binomial_2_lpmf(y_A | delta_x_1, phi) +
    neg_binomial_2_lpmf(y_B | delta_x_2, phi) +
    neg_binomial_2_lpmf(y_C | delta_x_3, phi) +
    neg_binomial_2_lpmf(y_D | delta_x_4, phi);
  sim_y_A = neg_binomial_2_rng(delta_x_1, phi);
  sim_y_B = neg_binomial_2_rng(delta_x_2, phi);
  sim_y_C = neg_binomial_2_rng(delta_x_3, phi);
  sim_y_D = neg_binomial_2_rng(delta_x_4, phi);
}
